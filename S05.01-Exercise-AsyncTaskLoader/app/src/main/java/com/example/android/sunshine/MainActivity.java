...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int WEATHER_LOADER = 35;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(WEATHER_LOADER, bundle, MainActivity.this);
    }
...
//    }
    ...
    public Loader onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            String[] forecastWeatherData = null;
            @Override
            protected void onStartLoading() {
                if(forecastWeatherData != null ){
                    deliverResult(forecastWeatherData);
                }
                else {
            ...
            public String[] loadInBackground() {
                ...
                if(args != null && args.containsKey(LOCATION_KEY)) {
                     location = args.getString(LOCATION_KEY);
                }
                else
                    location = SunshinePreferences.getPreferredWeatherLocation(MainActivity.this);
